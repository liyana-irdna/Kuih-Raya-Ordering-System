...
<br>
<br>
<h2 align="center" ><b>List of Status</b></h2>
<hr> <br>
<div class="container">
<a class="btn btn-primary" href="statusAdd.php" role="button">Add Status</a>
        ...
        <table class="table table-striped">
            ...
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                <tr>
                    ...
                    <td><a href="statusUpdate.php?id=<?php echo $row['idStatus']; ?>"><i class='glyphicon glyphicon-pencil' title="Update"></i> </a></td>
                    <td><a href="statusView.php?id=<?php echo $row['idStatus']; ?>"><i class='glyphicon glyphicon-eye-open' title="View"></i> </a></td>
                </tr>
