...
<form action="searchItemCust.php" method="post">
      ...
      <div class="input-group">
        <select  class="form-control" name="search">
          ...
          $records = mysqli_query($conn, "SELECT itemName from item ");  
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        <div class="col-md-3" style="margin-top:2%; ">      
          ...
          <div class="mypanel" align="center";>
              ...
              Jar Quantity (450ml/jar): <input type="number" max = "100" min = "0" class="product-quantity" name="quantity" value=" " size="2" /><br/>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-3 payment-options color-gray">
                ...
                <ul>
                <li>
                <a href="#"> <img src="images/facebook.png" alt="Paypal"> </a>
                </li>
                <li>
                <a href="#"> <img src="images/instagram.png" alt="Mastercard"> </a>
                </li>                               
                </ul>
              </div>
