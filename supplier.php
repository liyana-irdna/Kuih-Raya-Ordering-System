...
<br>
<br>
<h2 align="center" ><b>List of Supplier</b></h2>
<hr> <br>
<div class="container">
    <a class="btn btn-primary" href="supplierAdd.php" role="button">Add Supplier</a>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td><a href="supplierUpdate.php?id=<?php echo $row['idSupplier']; ?>"><i class='glyphicon glyphicon-pencil' title="Update"></i> </a></td>
                        <td><a href="supplierView.php?id=<?php echo $row['idSupplier']; ?>"><i class='glyphicon glyphicon-eye-open' title="View"></i> </a></td>
                    </tr>
